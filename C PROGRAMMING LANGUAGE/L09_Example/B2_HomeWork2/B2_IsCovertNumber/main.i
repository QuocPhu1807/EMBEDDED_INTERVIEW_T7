...
# 426 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/13.1.0/include/stddef.h" 3 4
typedef struct {
  long long __max_align_ll __attribute__((__aligned__(__alignof__(long long))));
  long double __max_align_ld __attribute__((__aligned__(__alignof__(long double))));
# 437 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/13.1.0/include/stddef.h" 3 4
} max_align_t;
...
# 4 "main.c" 2
# 1 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/13.1.0/include/stdbool.h" 1 3 4
# 5 "main.c" 2
# 13 "main.c"
...
char *unit[] = {" ","muoi", "tram", "nghin", "muoi", "tram", "trieu","muoi", "tram", "ty", "muoi", "tram", "nghin ty", "muoi", "tram", "trieu ty"};

char *unit1[] = {" ","linh", "tram", "nghin", "muoi", "tram", "trieu","muoi", "tram", "ty", "muoi", "tram", "nghin ty", "muoi", "tram", "trieu ty"};
...
int input(){
        ...
        if ( x <= 0 ) {
            printf("So khong hop le! Hay nhap so khac.\n");
        }

        return x;
}

words SplitArr(int size){
...
void printEleme1(words arr, char *Unit[], char *Unit1[],char *Unit2[]){


         for (int i = (arr.count) - 1 ; i >= 0; i--)
         {

             if(arr.ptr[0] == 0 && arr.ptr[1] == 0 )
             {
                   printf(" %s %s ",convertNumber(arr.ptr[(arr.count)-1]),Unit[(arr.count)-1]);
                   break;
             }

             else if ( arr.ptr[1] == 0 )
             {
                 printf("%s %s ",convertNumber(arr.ptr[i]),Unit1[i]) ;
             }

              else if ( arr.ptr[2] == 0 && arr.ptr[1] != 0 )
             {
                 printf("%s %s ",convertNumber(arr.ptr[i]),Unit2[i]) ;
             }

             else
             {
                 printf("%s %s ",convertNumber(arr.ptr[i]),Unit[i]) ;
             }
...
int main(int argc, char const *argv[])
{
    ...
    printEleme1(ptr1, unit, unit1, unit2);
